<template>
  <span class="no-more-text">{{text}}</span>
</template>
...
let strayBirds = {
  ...
  "125": "The great is a born child; when he dies he gives his great childhoodto the world.",
  ...
  "257": "I live in this little world of mine and am afraid to make it the least less. Life me into thy world and let me have the freedom gladlyto lose my all.",
  ...
  "294": "Truth seems to come with its final word; and the final word givesbirth to its next.",
...
export default {
  ...
  data() {
    return {
      text: strayBirds[Math.ceil(Math.random() * 325)]
    }
  }
}
</script>
